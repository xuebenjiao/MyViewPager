...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout frameLayout  = findViewById(R.id.view_Pager_layout);
        ViewParent viewParent = frameLayout.getParent();

        Log.i("TAG","the parent of mainLayout is " + viewParent);
        Log.i("TAG","the parent of ViewParent is " + viewParent.getParent());
